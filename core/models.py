...
LABEL_CHOICES = (
    # First parameter is what goes in the DB and 2nd is what's displayed
    ('P', 'primary'),
...
class Order(models.Model):  # Is like the shopping cart, all order items go in here
    ...
    ordered = models.BooleanField(default=False)
    shipping_address = models.ForeignKey( # Has related name because the ForeignKey is the same
    ...
    def get_total(self):
        ...
        if self.coupon: # If there is a coupon
...
class Address(models.Model):
    ...
    default = models.BooleanField(default=False) # For setting a default address
